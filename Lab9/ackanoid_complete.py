...
while not done:
    ...
    if pause==1:
        ...
        pygame.draw.rect(screen,(255,255,255),bl1)
        pygame.draw.rect(screen,(255,255,255),bl2)
        pygame.display.flip()
        if pygame.mouse.get_pressed() and pygame.mouse.get_pos()>(W/3+10,H/3+10) and pygame.mouse.get_pos()<(W/3+10+W/6-15,H/3+10+H/6-10):
            speed=0
            paddle.width=300
        if pygame.mouse.get_pressed() and pygame.mouse.get_pos()>(W/3+5+W/6,H/3+10) and pygame.mouse.get_pos()<(W/3+10+W/3-15,H/3+10+H/6-10):
            speed=0.005
            paddle.width=200
        clock.tick(FPS)